...
function Album() {
    ...
    const tracklist = location.state.item;
                ...
                <div className="albumDetail">
                    <div className="detail">
                        <div className="trackImg">
                            <img
                                src={tracklist.albumImage}
                                alt={tracklist.albumName} />
                    ...
                    <div className="albumTracksBody">
                        <div className='heading'>
                            <LibraryMusicIcon fontSize='small' /><div>Bài hát</div></div>
                        {tracks.map((item, key) => 
                        <div class='track'>
                            <TrackItem item={item} key={key} className='trackItem' />
                            <div className='fauxImg'>
                                <PlayCircleFilledRounded fontSize='large' className='playIcon' 
                                    onClick={() => {
                                    song.setUsing(true);
                                    song.setTracks(tracks);
                    ...
                    <div style={song.isUsing ? { height: "9em" } : { height: "15px" }}></div>
                </div>
            )}
        </div>
    )
