    ...
    return (
        <div className="newAlbumReleaseContainer">
            <div className="newAlbumsBtn">
                ...
                onClick={() => toggleTab(4)}>Hàn Quốc</button>
            </div>
                    ...
                    <div class='albumContainer'>
                        ...
                        <div className='fauxImg'>
                            <PlayCircleFilledRounded fontSize='large' className='icon' 
                                onClick={() => {
                                    setRnd(Math.floor(Math.random() * item.albumTracks.length));
                                    song.setUsing(true);
                                    song.setTracks(item.albumTracks);
                                    song.setSongIndex(rnd);
                                    song.setSong(item.albumTracks[rnd]);
                                }} 
                            />
                        </div>
